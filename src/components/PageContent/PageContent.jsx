...
export default function PageContent() {
    ...
    const [title, setTitle] = useState(musics[0].title);
    const [artist, setArtist] = useState(musics[0].artist);
    ...
    function previousMusic(currentMusic) {
        if (currentMusic.id === 1) {
            return clickCard(4)
        } else if (currentMusic.id === 2) {
            return clickCard(1)
        } else if (currentMusic.id === 3) {
            return clickCard(2)
        } else if (currentMusic.id === 4) {
            return clickCard(3)
        }
    }
    ...
    return (
        <div className="mainContent">
            <h1 className="title">The best play list</h1>
